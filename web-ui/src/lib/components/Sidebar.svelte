<script lang="ts">
	...
	onMount(async () => {
		let {data, success} = await waitfetchData("http://127.0.0.1:8000/user/info", "GET", {})
		console.log(data)
		if (success) {
          ...
          <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
              ...
              <a href="/" class="flex ms-2 md:me-24">
                <img src="/logo.jpg" class="h-9 me-3 rounded-full" alt="Logo" />
                <span class="self-center text-xl font-semibold sm:text-2xl whitespace-nowrap dark:text-white">PassGuard</span>
              </a>
            </div>
                ...
                <div class="flex items-center ms-3">
                  ...
                  <div class="z-50 border-2 border-gray-500 rounded-lg hidden my-4 text-base list-none bg-white divide-y divide-gray-100 shadow dark:bg-gray-700 dark:divide-gray-600" id="dropdown-user">
                    ...
                    <ul class="py-1" role="none">
                      <li>
                        <button type="button" on:click={logout} class="rounded block w-full px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:text-gray-300 dark:hover:bg-gray-600 dark:hover:text-red-500 font-bold" role="menuitem">
							Sign out
						</button>
                      </li>
                    </ul>
			...
			<ul class="space-y-2 font-medium">
				...
				<li>
					...
					>
						...
						<span class="ms-3 flex-1 whitespace-nowrap">Devices</span>
						<span
            ...
            <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
				<li>
					...
					>
						...
						<span class="ms-3 flex-1 whitespace-nowrap">Password Health</span>
					</a>
				</li>
                <li>
					<a
					...
					>
						...
						<span class="ms-3 flex-1 whitespace-nowrap">Password Generator</span>
					</a>
				</li>
			</ul>
            ...
            <div class="fixed bottom-3 w-56">
                <div id="dropdown-cta" class="p-4 mt-6 rounded-lg bg-blue-50 dark:bg-blue-900" role="alert">
                    ...
                    <p class="mb-3 text-sm text-blue-800 dark:text-blue-400">
                       This site is in beta. Please report any issues or feedback to our team.
                    </p>
                </div>
                <ul class="pt-4 mt-4 space-y-2 font-medium border-t border-gray-200 dark:border-gray-700">
                    <li>
