<div
	...
	class="mb-4 w-11/12 rounded-lg border border-blue-300 bg-blue-50 p-4 text-blue-800 dark:border-blue-800 dark:bg-gray-800 dark:text-blue-400"
	role="alert"
>
...
<div
	...
	class="mb-4 w-11/12 rounded-lg border border-red-300 bg-red-50 p-4 text-red-800 dark:border-red-800 dark:bg-gray-800 dark:text-red-400"
	role="alert"
>
	<div class="flex items-center">
		<svg
	...
	<div class="flex">
		<button
			type="button"
			class="me-2 inline-flex items-center rounded-lg bg-red-800 px-3 py-1.5 text-center text-xs font-medium text-white hover:bg-red-900 focus:outline-none focus:ring-4 focus:ring-red-300 dark:bg-red-600 dark:hover:bg-red-700 dark:focus:ring-red-800"
		>
			<svg
				class="me-2 h-3 w-3"
				aria-hidden="true"
...
<div
	...
	class="mb-4 w-11/12 rounded-lg border border-green-300 bg-green-50 p-4 text-green-800 dark:border-green-800 dark:bg-gray-800 dark:text-green-400"
	role="alert"
>
	<div class="flex items-center">
		<svg
	...
	<div class="flex">
		<button
			type="button"
			class="me-2 inline-flex items-center rounded-lg bg-green-800 px-3 py-1.5 text-center text-xs font-medium text-white hover:bg-green-900 focus:outline-none focus:ring-4 focus:ring-green-300 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"
		>
			<svg
				class="me-2 h-3 w-3"
				aria-hidden="true"
...
<div
	...
	class="mb-4 w-11/12 rounded-lg border border-yellow-300 bg-yellow-50 p-4 text-yellow-800 dark:border-yellow-800 dark:bg-gray-800 dark:text-yellow-300"
	role="alert"
>
	<div class="flex items-center">
		<svg
	...
	<div class="flex">
		<button
			type="button"
			class="me-2 inline-flex items-center rounded-lg bg-yellow-800 px-3 py-1.5 text-center text-xs font-medium text-white hover:bg-yellow-900 focus:outline-none focus:ring-4 focus:ring-yellow-300 dark:bg-yellow-300 dark:text-gray-800 dark:hover:bg-yellow-400 dark:focus:ring-yellow-800"
		>
			<svg
				class="me-2 h-3 w-3"
				aria-hidden="true"
...
<div
	...
	class="rounded-lg w-11/12 border border-gray-300 bg-gray-50 p-4 dark:border-gray-600 dark:bg-gray-800"
	role="alert"
>
	<div class="flex items-center">
		<svg
